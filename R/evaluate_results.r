...
evaluate_results <- function(Uhat, Vhat, example, 
  ...
  data.frame("method" = name_method,
             ...
             "prediction_tot" = mean((example$Xnew %*% Uhat - example$Ynew %*% Vhat)^2),
             "prediction_U" = mean((example$Xnew %*% Uhat - example$Xnew %*% example$u)^2),
             "prediction_V" = mean((example$Ynew %*% Vhat - example$Ynew %*% example$v)^2),
